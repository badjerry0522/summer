...
def _get_custom_lmclks(loc):
    ...
    print("lmk_loc = ",lmk_loc," lmx_loc = ",lmx_loc)
...
def set_custom_lmclks():
    ...
    clk_file_dir = "/home/xilinx/jupyter_notebooks/badjerry_ofdm_py/modules/"
    lmk_loc, lmx_loc = _get_custom_lmclks(clk_file_dir)
